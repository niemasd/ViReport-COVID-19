# ViReport v0.0.1 &mdash; 2020-04-10

## Input Dataset
The analysis was conducted on a dataset containing 5756 sequences. The average sequence length was 29855.973, with a standard deviation of 79.328. The earliest sample date was 2019-12-24, the median sample date was 2020-03-15, and the most recent sample date was 2020-04-03.
...
The input dataset was preprocessed such that sequences were given safe names: non-letters/digits in sequence IDs were converted to underscores. After preprocessing, the dataset contained 5756 sequences. The average sequence length was 29855.973, with a standard deviation of 79.328. The earliest sample date was 2019-12-24, the median sample date was 2020-03-15, and the most recent sample date was 2020-04-03.
...
Across the positions of the multiple sequence alignment, the minimum coverage was 0.308, the maximum coverage was 0.998, and the average coverage was 0.974, with a standard deviation of 0.0294.
...
<figcaption>Coverage (proportion of non-gap characters) across the positions of the multiple sequence alignment</figcaption>
 ...
 Across the positions of the multiple sequence alignment that had non-zero Shannon entropy, the minimum Shannon entropy was 0.00244, the maximum Shannon entropy was 1.0171, and the average Shannon entropy was 0.00912, with a standard deviation of 0.0476.
...
## Phylogenetic Dating
The rooted phylogeny was dated using treedater (Volz & Frost, 2017). The height of the dated tree was 101.0599 days, so given that the most recent sample was collected on 2020-04-03, the estimated time of the most recent common ancestor (tMRCA) was 2019-12-23. The tree was too large to draw.
## Ancestral Sequence Reconstruction
Ancestral sequence reconstruction was performed using TreeTime (Sagulenko et al., 2018).
## Transmission Clustering
Transmission clustering was performed using TreeN93 (Moshiri, 2018) using pairwise phylogenetic distances. The total number of singletons (i.e., non-clustered individuals) was 399, and the total number of clusters (excluding singletons) was 96. The average cluster size (excluding singletons) was 55.521, with a standard deviation of 489.0286, and the maximum and minimum cluster sizes were 4821 and 2, respectively.
