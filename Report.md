...
The maximum pairwise phylogenetic distance (i.e., tree diameter) was 0.00333,
and the average pairwise phylogenetic distance was 0.000392,
with a standard deviation of 0.000328.
...
The height of the dated tree was 0.338 days,
...
The total number of singletons (i.e., non-clustered individuals) was 51,
and the total number of clusters (excluding singletons) was 15.
The average cluster size (excluding singletons) was 15.133,
with a standard deviation of 31.324,
and the maximum and minimum cluster sizes were 128 and 2, respectively.
