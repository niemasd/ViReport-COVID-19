# ViReport v0.0.1 &mdash; 2020-03-12

## Input Dataset
The analysis was conducted on a dataset containing 449 sequences.
The average sequence length was 29801.497,
with a standard deviation of 315.377.
The earliest sample date was 2019-12-01,
the median sample date was 2020-02-08,
and the most recent sample date was 2020-03-06.
...
After preprocessing, the dataset contained 449 sequences.
The average sequence length was 29801.497,
with a standard deviation of 315.377.
The earliest sample date was 2019-12-01,
the median sample date was 2020-02-08,
...
There were 30333 positions (10453 invariant) and 397 unique sequences in the multiple sequence alignment.
Pairwise distances were computed from the multiple sequence alignment using the tn93 tool of HIV-TRACE (Pond et al., 2018).
The average pairwise sequence distance was 0.000269,
with a standard deviation of 0.000199.
...
The maximum pairwise phylogenetic distance (i.e., tree diameter) was 0.00416,
and the average pairwise phylogenetic distance was 0.000502,
with a standard deviation of 0.000357.
...
The height of the dated tree was 133.463 days,
so given that the most recent sample was collected on 2020-03-06,
...
The total number of singletons (i.e., non-clustered individuals) was 65,
and the total number of clusters (excluding singletons) was 22.
The average cluster size (excluding singletons) was 17,
with a standard deviation of 50.0491,
and the maximum and minimum cluster sizes were 241 and 2, respectively.
