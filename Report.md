# ViReport v0.0.1 &mdash; 2020-06-10

## Input Dataset
The analysis was conducted on a dataset containing 42374 sequences. The average sequence length was 29851.518, with a standard deviation of 86.766. The earliest sample date was 2019-12-24, the median sample date was 2020-03-31, and the most recent sample date was 2020-06-02.
...
The input dataset was preprocessed such that sequences were given safe names: non-letters/digits in sequence IDs were converted to underscores. After preprocessing, the dataset contained 42374 sequences. The average sequence length was 29851.518, with a standard deviation of 86.766. The earliest sample date was 2019-12-24, the median sample date was 2020-03-31, and the most recent sample date was 2020-06-02.
...
Multiple sequence alignment was performed using Minimap2 (Li, 2018). Each input sequence was aligned to the reference sequence (MT072688), and the multiple sequence alignment was constructed based on positions in the reference. There were 29808 positions (2 invariant) and 35059 unique sequences in the multiple sequence alignment. Pairwise distances were computed from the multiple sequence alignment using the tn93 tool of HIV-TRACE (Pond et al., 2018).
...
Across the positions of the multiple sequence alignment, the minimum coverage was 0.208, the maximum coverage was 0.998, and the average coverage was 0.973, with a standard deviation of 0.0386.
