# ViReport v0.0.1 &mdash; 2020-03-15

## Input Dataset
The analysis was conducted on a dataset containing 560 sequences.
The average sequence length was 29798.784,
with a standard deviation of 296.562.
...
After preprocessing, the dataset contained 560 sequences.
The average sequence length was 29798.784,
with a standard deviation of 296.562.
The earliest sample date was 2019-12-01,
the median sample date was 2020-02-25,
...
There were 30357 positions (8678 invariant) and 502 unique sequences in the multiple sequence alignment.
Pairwise distances were computed from the multiple sequence alignment using the tn93 tool of HIV-TRACE (Pond et al., 2018).
The average pairwise sequence distance was 0.000284,
with a standard deviation of 0.000192.
...
The maximum pairwise phylogenetic distance (i.e., tree diameter) was 0.00463,
and the average pairwise phylogenetic distance was 0.000595,
with a standard deviation of 0.000392.
...
The height of the dated tree was 99.54 days,
so given that the most recent sample was collected on 2020-03-09,
the estimated time of the most recent common ancestor (tMRCA) was 2019-11-30.
...
The total number of singletons (i.e., non-clustered individuals) was 94,
and the total number of clusters (excluding singletons) was 28.
The average cluster size (excluding singletons) was 16.286,
with a standard deviation of 31.708,
and the maximum and minimum cluster sizes were 147 and 2, respectively.
